...
public class TestFillListQuestCard {
    public static void main(String[] args) throws IOException {
        ...
        Question question1 = new Question(1L, """
                <p>После мгновения тишины в ваши уши врывается привычный гомон толпы.</p>
                <p>Вы находитесь в метро, застыв среди бесконечного людского потока.</p>
                <p>Многие тихо ругаются себе под нос когда сталкиваются с вами,
                но уже через мгновение вы чудесным образом стираетесь из их памяти и люди продолжают свой путь дальше.</p>
                <p>Впрочем вы не замечаете эти детали, а даже если бы захотели, сейчас есть дела поважнее.</p>
                <p>На часах 18:00. Ровно один час до начала трагической истории.</p>
                <p>Вы не можете ее остановить, но у вас есть время на подготовку.</p>
                ""","На что вы потратите этот час?","img/quests/id2/metro.jpg");
        ...
        Question question3 = new Question(3L, """
                <p>Вы лихорадочно вбиваете в смартфон поиск ближайших зоомагазинов и определившись с маршрутом двигаетесь в путь.</p>
                <p>По вашим внутренним ощущениям время почему-то начинает идти все быстрее, а поезд метро двигается все медленней.</p>
                <p>Потрачено 10 минут... 20 минут... 50 минут</p>
                ...
                <p>Плохая новость - перед вами слишком большая очередь.</p>
                ""","Вы явно не успеваете ничего купить за оставшееся время. Ваши действия?","img/quests/id2/zooShop.jpg");
        ...
        Question question2 = new Question(2L, """
                <p>В 19:00 тьма на мгновение окутывает ваше зрение и вы обнаруживаете себя в заполненном вагоне, со всех сторон зажатым людьми.</p>
                <p>Не успеваете вы приспособиться к внезапной смене обстановки, как слышите механический женский голос.</p>
                <p>[БЕСПЛАТНОЕ ОБСЛУЖИВАНИЕ ПЛАНЕТАРНОЙ СИСТЕМЫ 8612 БЫЛО ПРЕКРАЩЕНО]</p>
                <p>[С ЭТОГО МОМЕНТА НАЧНЁТСЯ МОНЕТИЗАЦИЯ] </p>
                <p>[ОСНОВНОЙ СЦЕНАРИЙ ЗАПУЩЕН]</p>
                <p>Ваше тело не желает двигаться, в то время как история продолжает развиваться согласно известной вам новелле.</p>
                <p>Появление токкэби, первые смерти и наконец паника после объявления первого задания.</p>
                <p>Беспомощный, вы можете только наблюдать и лишь после ухода причудливого существа к вам возвращается подвижность.</p>
        ...
        Question question4 = new Question(4L, """
                <p>Естественно за оставшиеся пять минут, очередь до вас не доходит.</p>
                <p>Затем ровно 19:00 тьма на мгновение окутывает ваше зрение и вы обнаруживаете себя в заполненном вагоне, со всех сторон зажатым людьми.</p>
                <p>Вы напряженно замираете, затем чувствуете текстуру стекла фермы, все еще зажатой под мышкой и слегка расслабляетесь.</p> 
                <p>В следующее мгновение со всех сторон звучит механический женский голос.</p>
                <p>[БЕСПЛАТНОЕ ОБСЛУЖИВАНИЕ ПЛАНЕТАРНОЙ СИСТЕМЫ 8612 БЫЛО ПРЕКРАЩЕНО]</p>
                <p>[С ЭТОГО МОМЕНТА НАЧНЁТСЯ МОНЕТИЗАЦИЯ] </p>
                <p>[ОСНОВНОЙ СЦЕНАРИЙ ЗАПУЩЕН]</p>
                <p>Вы пытаетесь вытащить муравья из фермы, но ваше тело не желает двигаться.</p>
                <p>В то же время история продолжает развиваться согласно известной вам новелле.</p>
                <p>Появление токкэби, первые смерти и наконец паника после объявления первого задания.</p>
                <p>Беспомощный, вы можете только наблюдать и лишь после ухода причудливого существа к вам возвращается подвижность.</p> 
                ""","До вашей гибели осталось 30 минут. Ваши действия?","img/quests/id2/startFirstScenario.jpg");
